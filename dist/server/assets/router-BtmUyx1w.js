import { T as reactExports, F as isPromise, G as isRedirect, E as isNotFound, A as invariant$1, g as createControlledPromise, $ as rootRouteId, H as isServer$1, u as functionalUpdate$1, b as arraysEqual, h as createLRUCache, e as compileDecodeCharMap, a1 as trimPath, _ as rewriteBasepath, f as composeRewrites, S as processRouteTree, Q as processRouteMasks, Z as resolvePath, d as cleanPath, a3 as trimPathRight, P as parseHref, p as executeRewriteInput, B as isDangerousProtocol, U as redirect, t as findSingleMatch, k as deepEqual, D as DEFAULT_PROTOCOL_ALLOWLIST, c as buildRouteBranch, z as interpolatePath, N as nullReplaceEqualDeep, W as replaceEqualDeep$1, K as last, j as decodePath, r as findFlatMatch, s as findRouteMatch, y as hasKeys, q as executeRewriteOutput, m as encodePathLikeUrl, a2 as trimPathLeft, I as joinPaths, a5 as useRouter, l as dummyMatchContext, L as matchContext, w as getDefaultExportFromCjs, X as requireReactDom, o as exactPathTest, V as removeTrailingSlash, R as React, J as jsxRuntimeExports, C as isModuleNotFoundError, a4 as useHydrated, n as escapeHtml, v as getAssetCrossOrigin, x as getScriptPreloadAttrs, a as appendUniqueUserTags, Y as resolveManifestCssLink, O as Outlet, M as notFound } from "./server-BjXA4Xi1.js";
...
const appCss = "/assets/styles-CsHh1sS9.css";
...
function CartProvider({ children }) {
  ...
  const remove = (id2, size) => setItems((p) => p.filter((x) => !(x.product.id === id2 && x.size === size)));
  const setQty = (id2, size, qty) => setItems(
    (p) => p.map((x) => x.product.id === id2 && x.size === size ? { ...x, qty: Math.max(1, qty) } : x)
  );
  const toggleWish = (id2) => {
    setWishlist((p) => p.includes(id2) ? p.filter((x) => x !== id2) : [...p, id2]);
  };
...
function Navbar() {
  ...
  reactExports.useEffect(() => setMobileOpen(false), [location.pathname]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-px mx-auto flex h-16 max-w-7xl items-center justify-between md:h-20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2 group", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid h-9 w-9 place-items-center rounded-full bg-primary text-primary-foreground font-display text-lg shadow-soft transition-transform group-hover:rotate-12", children: "🐾" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-xl tracking-tight", children: "PawWear" })
          ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "hidden md:grid h-10 w-10 place-items-center rounded-full hover:bg-secondary transition", "aria-label": "Search", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "h-[18px] w-[18px]" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: dark ? /* @__PURE__ */ jsxRuntimeExports.jsx(Sun, { className: "h-[18px] w-[18px]" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Moon, { className: "h-[18px] w-[18px]" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "relative hidden md:grid h-10 w-10 place-items-center rounded-full hover:bg-secondary transition", "aria-label": "Wishlist", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "h-[18px] w-[18px]" }),
              wishlist.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-1 right-1 h-4 min-w-4 px-1 grid place-items-center text-[10px] rounded-full bg-primary text-primary-foreground font-semibold", children: wishlist.length })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  ...
                  count > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-1 right-1 h-4 min-w-4 px-1 grid place-items-center text-[10px] rounded-full bg-primary text-primary-foreground font-semibold", children: count })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: mobileOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container-px mx-auto py-4 flex flex-col gap-1", children: nav.map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              Link,
              {
                to: n.to,
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "mt-32 border-t border-border bg-cream", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-px mx-auto max-w-7xl py-16 grid gap-12 md:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid h-9 w-9 place-items-center rounded-full bg-primary text-primary-foreground font-display text-lg", children: "🐾" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-xl", children: "PawWear" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-sm text-muted-foreground max-w-xs", children: "Premium fashion crafted for the most important member of your family." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 flex gap-2", children: [Instagram, Facebook, Twitter, Youtube].map((Icon2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: "#",
            "aria-label": "social",
      ...
      [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display text-base mb-4", children: col.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2 text-sm text-muted-foreground", children: col.links.map(([label, to]) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to, className: "hover:text-foreground transition", children: label }) }, label)) })
      ] }, col.title))
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-px mx-auto max-w-7xl py-6 flex flex-col md:flex-row items-center justify-between gap-2 text-xs text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " PawWear. Made with 🧡 for good boys & girls."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Free shipping over ₹1,499 · 30-day returns" })
    ] }) })
  ] });
}
function CartDrawer() {
      ...
      motion.aside,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-6 border-b border-border", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl", children: "Your bag" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setOpen(false), className: "grid h-9 w-9 place-items-center rounded-full hover:bg-secondary", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-5 w-5" }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-auto p-6 space-y-4", children: items.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full grid place-items-center text-center text-muted-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingBag, { className: "h-10 w-10 mx-auto opacity-40" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3", children: "Your bag is empty." })
          ] }) }) : items.map((it) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: it.product.image, alt: "", className: "h-24 w-24 rounded-2xl object-cover" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium leading-tight", children: it.product.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => remove(it.product.id, it.size), className: "text-muted-foreground hover:text-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-4 w-4" }) })
              ] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 flex items-center justify-between", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 border border-border rounded-full", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "grid h-7 w-7 place-items-center", onClick: () => setQty(it.product.id, it.size, it.qty - 1), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Minus, { className: "h-3 w-3" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm w-5 text-center", children: it.qty }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "grid h-7 w-7 place-items-center", onClick: () => setQty(it.product.id, it.size, it.qty + 1), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "h-3 w-3" }) })
                ] }),
          ...
          ] }, it.product.id + it.size)) }),
          items.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border p-6 space-y-4", children: [
...
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-muted-foreground", children: "This page chased a squirrel and never came back." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Link,
      {
        to: "/",
...
const Route$6 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "PawWear — Premium fashion for your best friend" },
      { name: "description", content: "Cozy hoodies, jackets, tees and accessories crafted for modern dogs." },
      { property: "og:title", content: "PawWear" },
      { property: "og:description", content: "Premium fashion for your best friend." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,400;9..144,500;9..144,600&family=Plus+Jakarta+Sans:wght@300;400;500;600;700&display=swap" }
    ]
  }),
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CartProvider, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Toaster, { position: "bottom-right", theme: "light", richColors: true })
  ] }) });
}
const $$splitComponentImporter$5 = () => import("./shop-B9HQz0h_.js");
const Route$5 = createFileRoute("/shop")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Browse cozy hoodies, jackets, tees and accessories for dogs of every size."
    }]
  })
});
const $$splitComponentImporter$4 = () => import("./customize-BkbyW1ka.js");
const Route$4 = createFileRoute("/customize")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Design a one-of-one tee for your dog. Upload a photo, pick a color, add their name."
    }]
  })
});
const $$splitComponentImporter$3 = () => import("./contact-Cbve105l.js");
const Route$3 = createFileRoute("/contact")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Get in touch with PawWear. We respond within 24 hours."
    }]
  })
});
const $$splitComponentImporter$2 = () => import("./about-CMEmD0Tl.js");
const Route$2 = createFileRoute("/about")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "How PawWear designs sustainable, premium dog fashion in small batches."
    }]
  })
});
const $$splitComponentImporter$1 = () => import("./index-CEFnivD7.js");
const Route$1 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Premium hoodies, jackets, tees and accessories designed for modern dogs."
    }]
  })
});
const hoodie = "/assets/product-hoodie-Cj7JP1mH.jpg";
const tee = "/assets/product-tee-o6IAP7zx.jpg";
const jacket = "/assets/product-jacket-DE_r8mIg.jpg";
const woof = "/assets/product-woof-BQREi2zt.jpg";
const sneakers = "/assets/product-sneakers-DIZ0l35C.jpg";
const products = [
  {
    id: "pawwear-hoodie",
    ...
    sizes: ["XS", "S", "M", "L", "XL"],
    description: "Soft brushed-fleece hoodie with a roomy hood and ribbed cuffs. Made from breathable organic cotton — designed for cozy mornings and Sunday strolls.",
    tag: "Best Seller"
  },
  {
    id: "birthday-tee",
    ...
    colors: ["Sunset", "Cream"],
    sizes: ["XS", "S", "M", "L"],
    description: "Make their big day adorable. Soft cotton blend with a hand-illustrated birthday print and contrast trims.",
    tag: "New"
  },
  {
    ...
    colors: ["Cocoa", "Sand"],
    sizes: ["S", "M", "L", "XL"],
    description: "Plush faux-fur jacket lined with a thermal layer to keep your best friend toasty in sub-zero walks."
  },
  {
    id: "funny-woof-tee",
    name: "Funny Woof Tee",
    ...
    colors: ["White", "Sunset"],
    sizes: ["XS", "S", "M", "L"],
    description: "Bold typographic statement tee in a buttery-soft cotton blend. Because every walk deserves a punchline."
  },
  {
    id: "paw-sneakers",
    name: "Paw Sneakers",
    ...
    colors: ["Cream/Sunset"],
    sizes: ["XS", "S", "M", "L"],
    description: "Grippy rubber sole, padded ankle and breathable canvas upper. Pavement and trail ready.",
    tag: "Limited"
  }
];
const findProduct = (id2) => products.find((p) => p.id === id2);
const $$splitNotFoundComponentImporter = () => import("./product._id-l4OodO6I.js");
const $$splitComponentImporter = () => import("./product._id-ZOXkd-kt.js");
const Route2 = createFileRoute("/product/$id")({
...
const CustomizeRoute = Route$4.update({
  id: "/customize",
  path: "/customize",
  getParentRoute: () => Route$6
});
...
const ProductIdRoute = Route2.update({
  id: "/product/$id",
  path: "/product/$id",
  getParentRoute: () => Route$6
});
